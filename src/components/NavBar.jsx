...
function NavBar()
{
  ...
  const handleClick = ()=>{
    ...
    <nav>
        ...
        <div>
          <ul id="navbar" className={myState? "navbar active":"navbar"}>
            <li><a className="active" href="index.html">Acceuil</a></li>
        ...
        <div id="mobile" onClick={handleClick}>
          <ul></ul>
          <i id="bar" className={myState  ? "fas fa-times ": "fas fa-bars"}></i>
        </div>
      </nav>
    </>)
}
